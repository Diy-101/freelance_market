  ...
  const toggleEmployeeMode = () => {
    ...
    if (!isEmployeeMode) {
      toast({
        ...
        description: "You can now receive job invitations and apply to projects.",
      });
    }
  };
          ...
          <CardContent className="p-6">
            ...
            <div className="flex gap-4 mt-4 pt-4 border-t border-border/50">
              <div className="text-center">
                <div className="text-lg font-bold text-success">${profileData.totalEarnings}</div>
                <div className="text-xs text-muted-foreground">Total Earned</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-bold text-primary">{profileData.completedProjects}</div>
                <div className="text-xs text-muted-foreground">Projects</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-bold text-warning">{profileData.rating}</div>
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {isEmployeeMode ? "You're available for hire" : "Enable to receive job invitations"}
                </p>
              </div>
              <Button
                onClick={toggleEmployeeMode}
                variant={isEmployeeMode ? "default" : "outline"}
                ...
                {isEditing ? (
                  <>
                    ...
                    <div className="flex gap-2">
                      <Button onClick={handleSaveProfile} className="telegram-button flex-1">
                        Save Changes
                      </Button>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">${profileData.hourlyRate}/hour</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setEmployeeProfile({...employeeProfile, portfolio: e.target.value})}
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setEmployeeProfile({...employeeProfile, experience: e.target.value})}
                    />
                  </div>
                </CardContent>
              </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-secondary/30 rounded-lg">
                    <DollarSign className="mx-auto text-success mb-2" size={20} />
                    <div className="font-bold">${profileData.totalEarnings}</div>
                    <div className="text-xs text-muted-foreground">Total Earned</div>
                  </div>
                  <div className="text-center p-3 bg-secondary/30 rounded-lg">
                    <Briefcase className="mx-auto text-primary mb-2" size={20} />
                    <div className="font-bold">{profileData.completedProjects}</div>
